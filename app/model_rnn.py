...
class RNNModel:
    def __init__(self, input_dim=11, hidden_dims=[64, 32], output_dim=1, dropout=0.2):
    ...
    def build_model(self):
        ...
        # Add RNN layers with dropout except last layer
        for i, hidden_dim in enumerate(self.hidden_dims):
            return_seq = i < len(self.hidden_dims) - 1
            model.add(layers.SimpleRNN(hidden_dim, return_sequences=return_seq))
